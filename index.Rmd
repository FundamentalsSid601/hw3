...
```{r}
# no column name correction required
life_exp <- data_2
```
...
head(life_exp)
str(life_exp)      # View structure and data types
summary(life_exp)  # View summary statistics
...
head(maternal)
str(maternal)       # View structure and data types
summary(maternal)   # View summary statistics
```
...
```{r}
# Convert infant mortality column to numeric
...
# Convert maternal mortality column to numeric
